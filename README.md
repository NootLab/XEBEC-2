# XEBEC-2
Compact high performance cartesian 3D printer. Built from the ashes of two Ender 3s *(one pro)*, reclaiming as much as possible all while keeping up with today's commercial expectations.  Project Cost: &lt;£200

![Life Designs (5)](https://github.com/user-attachments/assets/994e2783-a515-429c-bba2-d7bd7ac5ee7f)

## Features

- **Straightforward, self-tramming assembly**
- **Expanded print volume** — 230mm(X) × 230mm(Y) × 260mm(Z) *(same stock Ender 3 225mm bed; XEBEC simply uses more of it)*
...
## Status
> Currently awaiting a hot end fan and JST terminal kit to complete the electronics. Firmware preparation is underway in the meantime.
